                ...
                <ul>
                  ...
                  <li>
                    ...
                    <ul>
                      ...
                      <li><Link className={isRouteActive(routes.frontend.chat.controlled) ? styles.sidebarNavigationLinkActive : ''} href={routes.frontend.chat.controlled}>Controlled Chat</Link></li>
